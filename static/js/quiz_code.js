window.onload = function () {
    ...
    document.onclick = function (event) {
        ...
        if (event.target.classList.contains('reload-button')) {
            location.href='courses_almaty.html';
        }
    }
    ...
    function showResult() {
        ...
        locationButton.innerHTML = 'ПЕРЕЙТИ К КУРСАМ';
        locationButton.classList.add('reload-button');
        document.querySelector('main').appendChild(locationButton);
    }
